...
vision = Vision(field,index=1,type='firewire',guid=2672909588927744,buffersize=32) # greyscale mode
# vision2 = Vision2(field,index=2,type='firewire',guid=2672909587849792,buffersize=32) # greyscale mode
# vision = Vision(field,index=1,type='firewire',guid=2672909588927744,buffersize=32) # greyscale mode
